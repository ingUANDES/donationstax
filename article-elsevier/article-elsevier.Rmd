...
ggplot(Donaciones_total, aes(x = Fecha , y = monto_FM_UTM)) +
  ...
  ylim(0,2500)+
  xlim(as.Date("2008-11-30"),as.Date("2019-01-01"))+
  annotate("text", x = as.Date("2009-03-11"), y = 2000, label = "Law 19885")+
...
kable(tabla.ley) %>%
  kable_styling(bootstrap_options = "striped", position = "center",font_size = 8)
...
We use a pannel data regression (\ref{eq:1}) in order to study the effect of the change of law on the donations, and follow the next pannel structure
